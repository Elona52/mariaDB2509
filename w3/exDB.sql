...
INSERT INTO products VALUE(1, 'Chais',1 ,1 , '10 boxes x 20 bags', 18.00);
INSERT INTO products VALUE(2, 'Chang',1 ,1 , '24 - 12 oz bottles', 19.00);
INSERT INTO products VALUE(3, 'Aniseed Syrup',1 ,2 , '12 - 550 ml bottles', 10.00);
INSERT INTO products VALUE(4, "Chef Anton's Cajun Seasoning",2 ,2 , '48 - 6 oz jars', 22.00);
INSERT INTO products VALUE(5, "Chef Anton's Gumbo Mix",2 ,2 , '36 boxes', 21.35);

INSERT INTO products VALUE(6, "Grandma's Boysenberry Spread",3 ,2 , '12 - 8 oz jars', 25.00);
INSERT INTO products VALUE(7, "Uncle Bob's Organic Dried Pears",3 ,7 , '12 - 1 lb pkgs.', 30.00);
INSERT INTO products VALUE(8, 'Northwoods Cranberry Sauce',3 ,2 , '12 - 12 oz jars', 40.00);
INSERT INTO products VALUE(9, 'Mishi Kobe Niku',4 ,6 , '18 - 500 g pkgs.', 97.00);
INSERT INTO products VALUE(10, 'Ikura',4 ,8 , '12 - 200 ml jars', 31.00);
...
select COUNT(*) from products where price > 30;
select * from products where price < 30;
select COUNT(*) from products where price < 30;
select * from products where price = 30;
select * from products where price >= 30;
...
SELECT * FROM customers WHERE city IN ('Berlin','Luleå');
